...
class AdminMenu():
    def __init__(self, parent=None):
        ...
        cmmnUserBttn = Button(frame, text='Entrar', bg='#57a1f8', fg='white', border=0, font=('Segoe UI', 14, 'bold'), command=lambda: [frame.destroy(), self.adminSignin(parent)])
        cmmnUserBttn.place(x = 50, y=220, width=300, height=60)

    def adminSignin(self, parent):
        print("done")