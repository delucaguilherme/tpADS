...
from control.RegisterInsulinController import RegisterInsulinController as Controller

class RegisterInsulinScreen:
    def __init__(self, email):
        
        #configuração da janela
        self.root = CTk()
        self.root.title("Registrar Aplicação de Insulina")
        ...
        self.quantity = CTkEntry(
            master=self.root, 
            placeholder_text="quantidade", 
            width=210, height=30
        )
        self.quantity.place(relx=0.5, rely=0.34, anchor=CENTER)

        self.type = CTkComboBox(
            master=self.root, 
            values=["Ação Ultrarrápida", "Ação Rápida", "Ação Prolongada", "Ação Intermediária", "Ação lenta"]
        )
        self.type.place(relx=0.5, rely=0.40, anchor=CENTER)
        ...
        self.date.place(relx=0.5, rely=0.46, anchor=CENTER)
        ...
        self.time.place(relx=0.5, rely=0.52, anchor=CENTER)
        ...
        self.meal_type.place(relx=0.5, rely=0.58, anchor=CENTER)
        ...
        self.meal_time_1.place(relx=0.4, rely=0.64, anchor=CENTER)
        ...
        self.meal_time_2.place(relx=0.6, rely=0.64, anchor=CENTER)
        ...
        signup_bttn = CTkButton(
            ...
            font=('Segoe UI', 16),
            width=210, height=30, 
            command=lambda: [Controller.register_insulin(self, email)]
        )
        signup_bttn.place(relx=0.5, rely=0.73, anchor=CENTER)
