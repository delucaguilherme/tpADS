...
class HomeScreen: 
    def __init__(self):
        ...
        # logo da empresa
        icon_glicmed = CTkImage(light_image=Image.open(os.path.join(os.path.dirname(__file__), '../icons/GlicMed_icon.png')), size=(103, 113))
        text_glicmed = CTkImage(light_image=Image.open(os.path.join(os.path.dirname(__file__), '../icons/GlicMed_text.png')), size=(133, 28))
